...
type commands struct {
	name        string
	description string
	callback    func(lastResponse any) (interface{}, error)
}
	...
	return map[string]commands{
		"help": {
			...
			callback: func(lastResponse any) (interface{}, error) {
				...
				return pokeapi.MapResponse{}, nil
			},
		},
		"exit": {
			name:        "exit",
			description: "Exits pokedex",
			callback:    func(lastResponse any) (interface{}, error) { return pokeapi.MapResponse{}, errors.New("exit") },
		},
		"map": {
			name:        "map",
