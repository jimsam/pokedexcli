...
func printSpecies(r SpeciesResponse) {
	fmt.Println("- ", r.CaptureRate)
}

func (r SpeciesResponse) GetCaptureRate(resourceURL string, cache *pokecache.Cache) (int, error) {
